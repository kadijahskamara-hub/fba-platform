...
export const metadata = { title: 'FBA Home' }
  ...
  return (
    <>
      <div className="admin-header">
        <div>
          <h1 className="admin-title">FBA Home</h1>
          <p className="admin-subtitle">
            Pieces marked as FBA Home — {published} published, {draft} draft
          </p>
        </div>
      ...
      {products.length === 0 ? (
        <div className="empty-state">
          ...
          <h3>No FBA Home pieces yet</h3>
          <p>Add products and mark them as FBA Home pieces.</p>
