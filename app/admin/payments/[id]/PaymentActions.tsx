...
export default function PaymentActions({
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 14 }}>
      ...
      {canAllocate && noCandidatesReason && (
          ...
          {allocations.map(a => (
            <span key={a.id} style={{ display: 'inline-flex', gap: 6, alignItems: 'center', background: '#EEF3EE', padding: '3px 9px', borderRadius: 20 }}>
              ...
              <button
                ...
                onClick={() => { if (confirm(`Remove the ${money(a.amount)} allocation to ${a.invoiceNumber}?`)) call(`/api/admin/payments/${paymentId}/allocate`, { allocationId: a.id }, 'DELETE') }}
